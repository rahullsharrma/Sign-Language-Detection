...
class Application:
    ...
    def action_call(self):
        ...
        self.tx6.config(text="Ankush Makkar \n 2104069", font=("Courier", 15, "bold"))
        ...
        self.tx2.config(text="Abhishek Sharma \n 2104056", font=("Courier", 15, "bold"))
        ...
        self.tx3.config(text="Rajat \n 2104165", font=("Courier", 15, "bold"))
        ...
        self.tx6.config(text="Prof. Amandeep Singh Brar", font=("Courier", 20, "bold"))
